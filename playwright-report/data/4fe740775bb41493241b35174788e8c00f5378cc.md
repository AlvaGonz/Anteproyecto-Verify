...
- Name: projects\project-crud.spec.ts >> CRUD Proyectos — E2E con Mock >> READ — detalle de proyecto carga en /projects/:id
- Location: e2e\projects\project-crud.spec.ts:149:3
...
Locator: locator('h1')
Expected substring: "Residencial"
Timeout: 5000ms
...
- link "VeriFinca":
  - /url: "#/"
  - img "VeriFinca"
- heading "Error en la aplicacion" [level=2]
- paragraph: Ha ocurrido un error inesperado.
