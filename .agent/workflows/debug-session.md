...
PASO 1 → Ejecuta /consult-brain para verificar si este bug tiene un ADR o fue previamente documentado en Fuente 5 (BUG log).
...
PASO 3 → Genera el AGENT PROMPT quirúrjico para AGENT:
