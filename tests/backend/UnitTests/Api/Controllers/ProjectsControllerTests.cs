...
namespace UnitTests.Api.Controllers
{
    public class ProjectsControllerTests : IDisposable
    {
        ...
        public async Task GetProjects_WhenUserIsDeveloper_ReturnsOnlyDeveloperProjects()
        {
            ...
            _mockProjectService
                .Setup(s => s.GetAllProjectsWithCountAsync(developerId, 1, 50, null, null, null, null, It.IsAny<CancellationToken>()))
            ...
            // Act
            var result = await _controller.GetProjects(1, 50, null, null, null, null, CancellationToken.None);
