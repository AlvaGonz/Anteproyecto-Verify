...
public class ProjectServiceTests
{
    ...
    public async Task CreateProject_ShouldReturnDto_WhenValid()
    {
        ...
        var plan = Domain.Entities.PlanSuscripcion.Create(Guid.NewGuid(), "Test Plan", 1000m, 100, 10, true, true, 0, 100, false, false, false, false, false, false, "Comunidad", false);
