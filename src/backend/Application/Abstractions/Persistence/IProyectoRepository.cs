...
public interface IProyectoRepository
{
    ...
    Task<(IEnumerable<Proyecto> Items, int TotalCount)> GetAllWithCountAsync(Guid? usuarioId = null, int page = 1, int pageSize = 50, string? searchTerm = null, string? estados = null, DateTime? startDate = null, DateTime? endDate = null, CancellationToken cancellationToken = default);
    ...
    Task<double> GetAverageIntegridadValidadaAsync(Guid proyectoId, CancellationToken cancellationToken = default);
}
