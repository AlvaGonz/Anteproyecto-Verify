...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260801035655_AddTwoFactorToUsuario")]
    partial class AddTwoFactorToUsuario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Pago", b =>
                {
                    ...
                    b.Property<Guid?>("PlanSuscripcionIdsuscripcion")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("UsuarioLegacyIdUsuario")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("IdPago");

                    b.HasIndex("PlanSuscripcionIdsuscripcion");
            ...
            modelBuilder.Entity("Domain.Entities.Pago", b =>
                {
                    b.HasOne("Domain.Entities.PlanSuscripcion", "PlanSuscripcion")
                        .WithMany()
                        .HasForeignKey("PlanSuscripcionIdsuscripcion");

                    b.HasOne("Domain.Entities.UsuarioLegacy", "UsuarioLegacy")
                        .WithMany("Pagos")
                        .HasForeignKey("UsuarioLegacyIdUsuario");
