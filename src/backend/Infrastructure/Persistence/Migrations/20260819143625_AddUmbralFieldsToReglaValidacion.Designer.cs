...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819143625_AddUmbralFieldsToReglaValidacion")]
    partial class AddUmbralFieldsToReglaValidacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DatoValidado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DatosMatchJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DatosOcrJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("DatoValidado", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Hallazgo", b =>
                {
                    ...
                    b.Property<Guid?>("DatoValidadoId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.CatastroTitulo", b =>
                {
                    b.HasOne("Domain.Entities.DGII", null)
                        .WithMany()
                        .HasForeignKey("Rnc")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Hallazgo", b =>
                {
                    b.HasOne("Domain.Entities.DatoValidado", "DatoValidado")
                        .WithMany()
                        .HasForeignKey("DatoValidadoId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Domain.Entities.PagoIPI", b =>
                {
                    b.HasOne("Domain.Entities.DGII", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.PagoIPI", "Rnc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.Entities.Usuario", b =>
                {
                    b.HasOne("Domain.Entities.JCE_Ciudadano", "JceCiudadanoMock")
                        .WithMany()
