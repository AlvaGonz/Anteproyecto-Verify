  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-end gap-3 mb-6 print:hidden">
        <button type="button" className="h-10 px-4 flex items-center gap-2 rounded-xl bg-surface border border-outline-variant/10 text-on-surface-variant text-xs font-bold hover:bg-surface-raised transition-colors">
        ...
        <button type="button" className="h-10 px-4 flex items-center gap-2 rounded-xl bg-primary text-white text-xs font-bold hover:shadow-floating transition-all active:scale-95">
