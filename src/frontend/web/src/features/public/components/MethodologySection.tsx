  ...
  <section id="metodologia" className="py-32 px-6 bg-white overflow-hidden relative">
    <div className="max-w-7xl mx-auto space-y-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {/* Card 1: Large */}
        <m.div {...fadeInUp} className="md:col-span-2 bg-secondary p-12 rounded-[40px] text-white space-y-12 relative overflow-hidden group">
        ...
        {/* Card 2: Medium */}
        <m.div {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.1 }} className="bg-gray-50 p-10 rounded-[40px] flex flex-col justify-between border border-gray-100 hover:border-primary/20 transition-all">
          <div className="space-y-4">
        ...
        {/* Card 3: Medium */}
        <m.div {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.2 }} className="bg-white p-10 rounded-[40px] flex flex-col justify-between border border-gray-100 hover:border-primary/20 transition-all shadow-xl shadow-secondary/5">
          <div className="space-y-4">
