...
interface RulesManagePageLayoutProps {
  ...
  formData: CreateRuleCommand;
  setFormData: React.Dispatch<React.SetStateAction<CreateRuleCommand>>;
  rules: ReglaValidacionDto[];
  filteredRules: ReglaValidacionDto[];
  handleToggle: (id: string, currentName: string, isActivating: boolean) => Promise<void>;
  searchTerm: string;
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label htmlFor="rule-nombre" className="text-[10px] font-black text-secondary uppercase tracking-[0.2em] ml-2">Nombre de la Regla</label>
                  <input
                    id="rule-nombre"
                    type="text"
                    required
                ...
                <div className="space-y-2">
                  <label htmlFor="rule-condicion" className="text-[10px] font-black text-secondary uppercase tracking-[0.2em] ml-2">Condición Lógica (DSL)</label>
                  <input
                    id="rule-condicion"
                    type="text"
                    required
              ...
              <div className="space-y-2">
                <label htmlFor="rule-desc" className="text-[10px] font-black text-secondary uppercase tracking-[0.2em] ml-2">Descripción Funcional</label>
                <textarea
                  id="rule-desc"
                  rows={3}
    ...
    <div className="flex flex-col gap-6">
      <div className="vf-card !p-3 flex flex-col sm:flex-row items-center gap-3">
        <div className="relative flex-1 group w-full">
          ...
          <input
            type="text"
            aria-label="Filtrar reglas por nombre o lógica"
