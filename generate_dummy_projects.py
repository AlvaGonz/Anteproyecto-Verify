...
if csv_cache_path:
    ...
    print("Writing no-op 14_Proyectos_Realistas.sql because CSV seeding is handled by C# API seeder...")
    lines = [
        "-- ============================================================",
        "-- 14_Proyectos_Realistas.sql (HANDLED BY API C# SEEDER)",
        "-- ============================================================",
        "PRINT 'Projects seeding from CSV cache is handled by AppDbContextSeeder in API lifecycle.';"
    ]
    with open(os.path.join(output_dir, "14_Proyectos_Realistas.sql"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print("No-op 14_Proyectos_Realistas.sql written successfully.")
    import sys
    sys.exit(0)
# ---------------------------------------------------------
